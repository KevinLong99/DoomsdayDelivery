...
namespace ActuateClient {
	...
	[StructLayout(LayoutKind.Sequential, Pack = 1)]
	public struct UdpPacketPayload_Telemetry {
	...
	[StructLayout(LayoutKind.Sequential, Pack = 1)]
	public struct UdpPacketPayload_ConfigureTelemType {
		[MarshalAs(UnmanagedType.I4)]
		public int TelemetryType;
	}

	[StructLayout(LayoutKind.Sequential, Pack = 1)]
	public struct UdpPacketPayload_StartEffect {
		[MarshalAs(UnmanagedType.I4)]
	...
	[StructLayout(LayoutKind.Sequential, Pack = 1)]
	public struct UdpPacketPayload_StopEffect {
		[MarshalAs(UnmanagedType.I4)]
		public int EffectType;
	}
}
